...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getAttendances: (sectorId: string, startDate: string, endDate: string) =>
        ipcRenderer.invoke('get-attendances', sectorId, startDate, endDate),
...
export type ElectronAPI = {
    ...
    getAttendances: (sectorId: string, startDate: string, endDate: string) => Promise<any[]>;
